...
public class MainActivity extends Activity {
     ...
     */
    private static final String CLIENT_ID = "AKS3SR1BGXXLTUGFG5FJCTWBOKNLXNBGFXATUFBWSBNDFCAT";
    private static final String CLIENT_SECRET = "DSEY5NPYECJ5DJHK5ENXKSC1EGCCOVCLC0V4ZE4Y5ZACHJAE";
    ...
    @AfterViews
    void ensureUi() {
        boolean isAuthorized = !TextUtils.isEmpty(ExampleTokenStore.get().getToken(this));
        
        TextView tvMessage = (TextView) findViewById(R.id.tvMessage);
        tvMessage.setVisibility(isAuthorized ? View.VISIBLE : View.GONE); // tokenが存在すればView.VISIBLE
    ...
    void onCompleteTokenExchange(int resultCode, Intent data) {
        ...
        if (exception == null) {
            ...
            // it to shared prefs.
            ExampleTokenStore.get().setToken(this, accessToken);
     ...
     */
    void performTokenExchange(String code) {
